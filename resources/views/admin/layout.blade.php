    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Keep Read <sup>ing</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{request()->is('admin/bukubaru') ? 'active' : ''}}" href="/admin/bukubaru">Buku Baru</a>
                        <a class="collapse-item {{request()->is('admin/koleksiumum') ? 'active' : ''}}" href="/admin/koleksiumum">Koleksi Umum</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin Bambang</span>
            ...
            <footer class="sticky-footer bg-secondary">
                <div class="container my-auto">
                    <p class="text-white">&copy; Copyright, Inspired by : Perpusnas.go.id</p>
                </div>
            </footer>
            <!-- End of Footer -->
